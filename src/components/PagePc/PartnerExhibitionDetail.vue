...
<script>
  import PartnerExhibitionDetailPc from '@/components/Pages/PartnerExhibitionDetailPc.vue'

  export default {
    name: 'PagePartnerExhibitionDetail',
    components: { 
      PartnerExhibitionDetailPc 
    },
    data() {
      return {
        enablePage: false,
        ...
        boards: [{"id": 536489, "name": "PartnerExhibitionDetailPc", "template_name": "", "route_pc__id": 72043, "activated": true, "login_required": false, "grade": null, "partner_grade": null, "order_conversion_type": null, "category1": null, "category2": null, "category3": null, "tab_name": "", "tab_index": 0}]
      }
    },
    watch: {
      componentName(n) {
