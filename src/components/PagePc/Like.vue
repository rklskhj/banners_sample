...
<div class="tab-page" style="min-height:100vh">
  <div id="tab-view-title" class="flex-justify position-relative">
    ...
    <script>
      import LikeProductPc from '@/components/Pages/LikeProductPc.vue'
import LikePartnerPc from '@/components/Pages/LikePartnerPc.vue'
      ...
      export default {
        ...
        data() {
          return {
            ...
            boards: [{"id": 0, "name": "LikeProductPc", "template_name": "", "route_pc__id": 72049, "activated": true, "login_required": true, "grade": 1, "partner_grade": null, "order_conversion_type": null, "category1": null, "category2": null, "category3": null, "tab_name": "상품", "tab_index": 0}, {"id": 1, "name": "LikePartnerPc", "template_name": "", "route_pc__id": 72049, "activated": true, "login_required": true, "grade": 1, "partner_grade": null, "order_conversion_type": null, "category1": null, "category2": null, "category3": null, "tab_name": "파트너", "tab_index": 1}]
          }
        },
