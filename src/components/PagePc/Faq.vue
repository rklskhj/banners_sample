...
<script>
  import FaqPc from '@/components/Pages/FaqPc.vue'
  ...
  export default {
    ...
    data() {
      return {
        ...
        boards: [{"id": 536499, "name": "FaqPc", "template_name": "", "route_pc__id": 72057, "activated": true, "login_required": false, "grade": null, "partner_grade": null, "order_conversion_type": null, "category1": null, "category2": null, "category3": null, "tab_name": "", "tab_index": 0}]
      }
    },
    watch: {
      componentName(n) {
