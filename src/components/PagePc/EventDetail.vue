...
<script>
  import EventDetailPc from '@/components/Pages/EventDetailPc.vue'
  ...
  export default {
    ...
    data() {
      return {
        ...
        boards: [{"id": 536471, "name": "EventDetailPc", "template_name": "", "route_pc__id": 72072, "activated": true, "login_required": false, "grade": null, "partner_grade": null, "order_conversion_type": null, "category1": null, "category2": null, "category3": null, "tab_name": "", "tab_index": 0}]
      }
    },
    watch: {
      componentName(n) {
