...
<script>
  import PartnerCenterPc from '@/components/Pages/PartnerCenterPc.vue'

  export default {
    name: 'PagePartnerCenter',
    components: { 
      PartnerCenterPc 
    },
    data() {
      return {
        ...
        boards: [{"id": 536689, "name": "PartnerCenterPc", "template_name": "", "route_pc__id": 72080, "activated": true, "login_required": false, "grade": null, "partner_grade": null, "order_conversion_type": null, "category1": null, "category2": null, "category3": null, "tab_name": null, "tab_index": 0}]
      }
    },
    watch: {
      componentName(n) {
