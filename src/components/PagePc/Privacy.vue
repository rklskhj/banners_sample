...
<script>
  import PrivacyPc from '@/components/Pages/PrivacyPc.vue'
  ...
  export default {
    ...
    data() {
      return {
        ...
        boards: [{"id": 536503, "name": "PrivacyPc", "template_name": "", "route_pc__id": 72055, "activated": true, "login_required": false, "grade": null, "partner_grade": null, "order_conversion_type": null, "category1": null, "category2": null, "category3": null, "tab_name": null, "tab_index": 0}]
      }
    },
    watch: {
      componentName(n) {
