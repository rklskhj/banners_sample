...
<script>
  import ExhibitionDetailPc from '@/components/Pages/ExhibitionDetailPc.vue'

  export default {
    name: 'PageExhibitionDetail',
    components: { 
      ExhibitionDetailPc 
    },
    data() {
      return {
        ...
        boards: [{"id": 536477, "name": "ExhibitionDetailPc", "template_name": "", "route_pc__id": 72068, "activated": true, "login_required": false, "grade": null, "partner_grade": null, "order_conversion_type": null, "category1": null, "category2": null, "category3": null, "tab_name": "", "tab_index": 0}]
      }
    },
    watch: {
      componentName(n) {
