...
<script>
  import ContactDetailMemberPc from '@/components/Pages/ContactDetailMemberPc.vue'

  export default {
    name: 'PageContactDetail',
    components: { 
      ContactDetailMemberPc 
    },
    data() {
      return {
        enablePage: false,
        ...
        boards: [{"id": 536493, "name": "ContactDetailMemberPc", "template_name": "", "route_pc__id": 72062, "activated": true, "login_required": true, "grade": null, "partner_grade": null, "order_conversion_type": null, "category1": null, "category2": null, "category3": null, "tab_name": "", "tab_index": 0}]
      }
    },
    watch: {
      componentName(n) {
