...
<script>
  import ContactMemberPc from '@/components/Pages/ContactMemberPc.vue'
  ...
  export default {
    ...
    data() {
      return {
        ...
        boards: [{"id": 536458, "name": "ContactMemberPc", "template_name": "", "route_pc__id": 72041, "activated": true, "login_required": true, "grade": null, "partner_grade": null, "order_conversion_type": null, "category1": null, "category2": null, "category3": null, "tab_name": "", "tab_index": 0}]
      }
    },
    watch: {
      componentName(n) {
