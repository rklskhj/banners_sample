...
<script>
  import PartnerSearchPc from '@/components/Pages/PartnerSearchPc.vue'

  export default {
    name: 'PagePartnerSearch',
    components: { 
      PartnerSearchPc 
    },
    data() {
      return {
        ...
        boards: [{"id": 536491, "name": "PartnerSearchPc", "template_name": "", "route_pc__id": 72064, "activated": true, "login_required": false, "grade": null, "partner_grade": null, "order_conversion_type": null, "category1": null, "category2": null, "category3": null, "tab_name": "", "tab_index": 0}]
      }
    },
    watch: {
      componentName(n) {
