...
<script>
  import TermsofservicePc from '@/components/Pages/TermsofservicePc.vue'
  ...
  export default {
    ...
    data() {
      return {
        ...
        boards: [{"id": 536505, "name": "TermsofservicePc", "template_name": "", "route_pc__id": 72054, "activated": true, "login_required": false, "grade": null, "partner_grade": null, "order_conversion_type": null, "category1": null, "category2": null, "category3": null, "tab_name": null, "tab_index": 0}]
      }
    },
    watch: {
      componentName(n) {
