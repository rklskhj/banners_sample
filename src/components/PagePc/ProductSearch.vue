...
<script>
  import ProductSearchPc from '@/components/Pages/ProductSearchPc.vue'

  export default {
    name: 'PageProductSearch',
    components: { 
      ProductSearchPc 
    },
    data() {
      return {
        ...
        boards: [{"id": 536485, "name": "ProductSearchPc", "template_name": "", "route_pc__id": 72045, "activated": true, "login_required": false, "grade": null, "partner_grade": null, "order_conversion_type": null, "category1": null, "category2": null, "category3": null, "tab_name": "", "tab_index": 0}]
      }
    },
    watch: {
      componentName(n) {
