...
<script>
  import PartnerInquiryRegPc from '@/components/Pages/PartnerInquiryRegPc.vue'

  export default {
    name: 'PagePartnerInquiryReg',
    components: { 
      PartnerInquiryRegPc 
    },
    data() {
      return {
        ...
        boards: [{"id": 536697, "name": "PartnerInquiryRegPc", "template_name": "", "route_pc__id": 72081, "activated": true, "login_required": false, "grade": null, "partner_grade": null, "order_conversion_type": null, "category1": null, "category2": null, "category3": null, "tab_name": null, "tab_index": 0}]
      }
    },
    watch: {
      componentName(n) {
