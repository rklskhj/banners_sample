  ...
  <div style="margin-top: 32px; padding-bottom: 120px">
    <div :style="pagePadding">
      <div class="flex-between">
        <div class="size-14"
          :style="brandColor.sub">전체 상품 {{ currencyNum(totalCount) }}개</div>
    ...
    <product-filter-list v-if="showFilterList" @selectFilter="getData" style="margin-top: 8px"></product-filter-list>
    ...
    <div v-else-if="list && list.length === 0"
      style="margin-top: 36px" :style="pagePadding">
