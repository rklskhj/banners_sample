<template>
<div class="partner-inquiry-container full-width flex-justify" :style="[pagePadding]" 
  style="padding:16px">
  <!-- 후기 작성 -->
  <div class="full-width">
    <div class="size-14" :style="brandColor.sub">
      아래 입점 문의를 남겨주시면 담당자가 연락을 드립니다.</div>
  ...
  <sweet-modal ref="modal" overlay-theme="dark" hideCloseButton>
    <div class="text-center" style="margi-top:20px">
      <div class="size-16 weight-500 p-main">입점문의가 등록되었습니다.</div>
      <div class="size-14 p-sub" style="margin:8px 0 60px 0">담당자가 확인 후 연락을 드립니다.</div>
      <button class="unselect button p-bg-white p-border-main p-sub size-14 weight-700" style="width:100%" @click="clickDone">확인</button>
    </div>
  </sweet-modal>
</div>
</template>
      ...
      this.formData.push(
        {
          ...
          "items": [
            {
              "link": "PartnerInquiryPrivacyModal",
              "text": "개인정보처리방침",
              "styles": {
                "container": {
