<template>
<div class="full-width" style="height: 100vh; overflow-y: auto; padding: 66px 16px 16px; text-align: left">
        
        <div class="position-relative flex-align p-bg-white"
          style="position: fixed; width: 100%; top: 0; left: 0; height: 50px">
        ...
        <div class="full-width">
            ...
            <div class="p-border-bottom-sub" style="margin-bottom:12px; padding-bottom: 12px">
                <card-review-reg
                  :showSoldout="false"
            ...
            <div class="unselect" :style="buttonCustom" style="margin-top: 24px" @click="save">저장하기</div>
  ...
  methods: {
    initForm() {
        this.formData.forEach(item => {
          ...
          item.containerCustom.marginTop = '24px'
        })
        ...
        let rating = find(this.formData, 'field', 'rate');
        rating.containerCustom.marginTop = '0px'
