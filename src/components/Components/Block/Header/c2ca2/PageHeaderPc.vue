...
<div class="page-header-relative full-width" :style="containerBg">
  <div class="flex-justify" :style="brandBgColor.sub2">
    <div class="flex-between" :style="pcMaxWidth">
      <button-partner-center :iconSize="20" :textStyle="centerStyle"></button-partner-center>
  ...
  <div class="flex-justify position-relative">
    <div class="flex-between" :style="pcMaxWidth">
      ...
      <div class="flex-align" style="gap:28px">
