<template>
  <div :style="pagePadding" style="padding-top:20px; padding-bottom:20px;height: 100%">
    ...
    <div class="flex-between" style="margin-bottom:12px;">
      ...
      <div v-if="$store.getters.social_key.naver.map.client_id !== ''"
           class="col-6 button size-12 flex-between unselect" style="padding:8px; width: 116px; height:32px; border-radius:4px;"
    ...
    <div class="full-width" style="height: calc(100% - 112px); overflow-y: hidden">
      <!-- 시도/시군구 데이터 -->
      <div class="flex size-12 weight-500" style="height:100%"
           :style="{borderTop: brandBorder.main.border, borderBottom: brandBorder.main.border}">
        <!-- 시도 (좌측) -->
