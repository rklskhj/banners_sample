...
<div class="p-border-bottom-sub" style="padding:16px 0">
    <!-- 상품 정보 -->
    <div class="unselect flex-align full-width" @click="clickCard">
      ...
      <div style="padding-left:12px;flex:1">
        ...
        <div class="size-10 p-sub">{{ card.product_info.simple_desc }}</div>
      </div>
    </div>
    ...
    <div class="flex-between" style="margin:12px 0 4px 0">
      ...
      <div class="flex-align" style="gap: 0 8px">
        <div class="unselect size-12 radius-6 flex-center btn p-border-sub p-sub" @click="clickEdit">수정</div>
        <div class="unselect size-12 radius-6 flex-center btn p-border-sub p-sub" @click="clickDelete">삭제</div>
      </div>
    </div>
    ...
    <div class="size-13 p-sub" style="margin-top:2px;line-height:20px">{{ card.content }}</div>
    <!-- 답변 -->
