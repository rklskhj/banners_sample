...
<script>
  import MyPageMember from '@/components/Pages/MyPageMember.vue'
import MyPageGuest from '@/components/Pages/MyPageGuest.vue'

  export default {
    name: 'PageMypage',
    components: { 
      MyPageMember, MyPageGuest 
    },
    data() {
      return {
        enablePage: false,
        ...
        boards: [{"id": 536446, "name": "MyPageMember", "template_name": "", "route__id": 72058, "activated": true, "login_required": true, "grade": null, "partner_grade": null, "order_conversion_type": null, "category1": null, "category2": null, "category3": null, "tab_name": "", "tab_index": 0}, {"id": 536448, "name": "MyPageGuest", "template_name": "", "route__id": 72058, "activated": true, "login_required": false, "grade": null, "partner_grade": null, "order_conversion_type": null, "category1": null, "category2": null, "category3": null, "tab_name": "", "tab_index": 0}]
      }
    },
    watch: {
      componentName(n) {
