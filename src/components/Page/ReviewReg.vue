...
<script>
  import ReviewReg from '@/components/Pages/ReviewReg.vue'
  ...
  export default {
    ...
    data() {
      return {
        ...
        boards: [{"id": 536455, "name": "ReviewReg", "template_name": "", "route__id": 72069, "activated": true, "login_required": false, "grade": null, "partner_grade": null, "order_conversion_type": null, "category1": null, "category2": null, "category3": null, "tab_name": "", "tab_index": 0}]
      }
    },
    watch: {
      componentName(n) {
