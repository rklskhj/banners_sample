...
<script>
  import CallListMember from '@/components/Pages/CallListMember.vue'
  ...
  export default {
    ...
    data() {
      return {
        ...
        boards: [{"id": 536537, "name": "CallListMember", "template_name": "", "route__id": 72046, "activated": true, "login_required": true, "grade": null, "partner_grade": null, "order_conversion_type": 1, "category1": null, "category2": null, "category3": null, "tab_name": "", "tab_index": 0}]
      }
    },
    watch: {
      componentName(n) {
