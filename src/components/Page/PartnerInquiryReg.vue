...
<script>
  import PartnerInquiryReg from '@/components/Pages/PartnerInquiryReg.vue'
  ...
  export default {
    ...
    data() {
      return {
        ...
        boards: [{"id": 536695, "name": "PartnerInquiryReg", "template_name": "", "route__id": 72081, "activated": true, "login_required": false, "grade": null, "partner_grade": null, "order_conversion_type": null, "category1": null, "category2": null, "category3": null, "tab_name": null, "tab_index": 0}]
      }
    },
    watch: {
      componentName(n) {
