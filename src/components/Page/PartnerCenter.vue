...
<script>
  import PartnerCenter from '@/components/Pages/PartnerCenter.vue'
  ...
  export default {
    ...
    data() {
      return {
        ...
        boards: [{"id": 536688, "name": "PartnerCenter", "template_name": "", "route__id": 72080, "activated": true, "login_required": false, "grade": null, "partner_grade": null, "order_conversion_type": null, "category1": null, "category2": null, "category3": null, "tab_name": null, "tab_index": 0}]
      }
    },
    watch: {
      componentName(n) {
