...
<script>
  import ContactRegGuest from '@/components/Pages/ContactRegGuest.vue'
import ContactRegMember from '@/components/Pages/ContactRegMember.vue'

  export default {
    name: 'PageContactReg',
    components: { 
      ContactRegGuest, ContactRegMember 
    },
    data() {
      return {
        enablePage: false,
        ...
        boards: [{"id": 536461, "name": "ContactRegGuest", "template_name": "", "route__id": 72063, "activated": true, "login_required": false, "grade": null, "partner_grade": null, "order_conversion_type": null, "category1": null, "category2": null, "category3": null, "tab_name": "", "tab_index": 0}, {"id": 536462, "name": "ContactRegMember", "template_name": "", "route__id": 72063, "activated": true, "login_required": true, "grade": null, "partner_grade": null, "order_conversion_type": null, "category1": null, "category2": null, "category3": null, "tab_name": "", "tab_index": 0}]
      }
    },
    watch: {
      componentName(n) {
