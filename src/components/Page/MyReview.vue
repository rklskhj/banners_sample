...
<script>
  import MyReview from '@/components/Pages/MyReview.vue'
  ...
  export default {
    ...
    data() {
      return {
        ...
        boards: [{"id": 536473, "name": "MyReview", "template_name": "", "route__id": 72071, "activated": true, "login_required": false, "grade": null, "partner_grade": null, "order_conversion_type": null, "category1": null, "category2": null, "category3": null, "tab_name": "", "tab_index": 0}]
      }
    },
    watch: {
      componentName(n) {
