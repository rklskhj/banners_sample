...
<script>
  import PartnerExhibitionDetail from '@/components/Pages/PartnerExhibitionDetail.vue'

  export default {
    name: 'PagePartnerExhibitionDetail',
    components: { 
      PartnerExhibitionDetail 
    },
    data() {
      return {
        enablePage: false,
        ...
        boards: [{"id": 536488, "name": "PartnerExhibitionDetail", "template_name": "", "route__id": 72043, "activated": true, "login_required": false, "grade": null, "partner_grade": null, "order_conversion_type": null, "category1": null, "category2": null, "category3": null, "tab_name": "", "tab_index": 0}]
      }
    },
    watch: {
      componentName(n) {
